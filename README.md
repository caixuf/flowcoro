...
| 特性 | FlowCoro | std::thread | Go协程 | Node.js |
|------|----------|-------------|--------|---------|
| 创建速度 | 4.33M/s | ~10K/s | ~1M/s | ~100K/s |
| 内存开销 | 262字节 | 8MB | 2KB | ~1KB |
| 调度延迟 | 0.002ms | 0.193ms | ~1μs | ~10μs |
| 并发吞吐量 | **500K req/s** | 5.2K req/s | ~50K req/s | ~30K req/s |
| 扩展性 | 1000+ | 受限 | 100万+ | 10万+ |
| 性能优势 | **基准** | 96.5x慢 | 10x慢 | 16x慢 |

*数据基于最新16核CPU环境的独立进程测试结果 (2025-07-25)*
