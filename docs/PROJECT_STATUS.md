...
**大规模并发测试**（10,000个并发请求）：
- ⚡ **性能优势**: 协程比传统多线程快 **80.1倍**
- 🎯 **吞吐量**: 25,445 请求/秒 vs 317 请求/秒
- 📈 **延迟**: 0.039ms vs 3.15ms（降低80倍）
- 🏗️ **架构**: 主线程协程池 + 32-128后台线程池

**中等规模测试**（3,000个并发请求）：
- ⚡ **性能优势**: 协程比传统多线程快 **83.4倍**
- 🎯 **吞吐量**: 26,315 请求/秒 vs 315 请求/秒

## 项目概述

FlowCoro 是一个基于 C++20 协程的高性能异步编程库，在大规模并发场景下展现出了卓越的性能优势。核心功能包括：
